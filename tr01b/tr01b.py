...
@Brief:  SCC0216 - Modelagem Computacional em Grafos
         ...
         [1,2,4,8,9,10,12,13,14] não é rotulável com uma única cor,
         porém é possível descartar um dos vértices mencionados e
         obter um novo subconjunto dos vértices, todos rotuláveis
...
def main(): 
    ...
    vertices_to_check = [1, 2, 4, 8, 9, 10, 12, 13, 14]
